...
@property (nonatomic, strong, readonly) id bxh_SafeAreaLayoutGuide;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideLeading;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideTrailing;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideLeft;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideRight;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideTop;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideBottom;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideWidth;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideHeight;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideCenterX;
@property (nonatomic, strong, readonly) MASViewAttribute *bxh_safeAreaLayoutGuideCenterY;
